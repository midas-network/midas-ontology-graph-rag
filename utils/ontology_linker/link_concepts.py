...
from utils.ontology_linker.ontology_lookup import lookup_in_all_ontologies
...
def compute_definition_similarity(llm_definition: Optional[str], ontology_definition: Optional[str]) -> tuple[Optional[float], str]:
...
def link_concepts_to_ontologies(extracted_data: Dict, ontologies: Dict, *, logger: logging.Logger = LOGGER):
